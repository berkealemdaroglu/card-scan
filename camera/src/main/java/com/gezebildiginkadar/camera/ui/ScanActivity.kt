...
import com.gezebildiginkadar.camera.scan_camera.getCameraAdapter
...
import com.gezebildiginkadar.camera.scan_framework.api.NetworkResult
...
import com.gezebildiginkadar.camera.scan_ui.CameraErrorListenerImpl
...
interface ScanResultListener {
     ...
     */
    fun userCanceled(reason: CancellationReason.UserCannotScan)
...
abstract class ScanActivity : AppCompatActivity(), CoroutineScope {
    ...
    protected open fun ensurePermissionAndStartCamera() = when {
        ...
        storage.getBoolean(com.gezebildiginkadar.camera.scan_ui.PERMISSION_RATIONALE_SHOWN, false) -> showPermissionDeniedDialog()
    ...
    protected open fun showPermissionRationaleDialog() {
        ...
        builder.show()
        storage.storeValue(com.gezebildiginkadar.camera.scan_ui.PERMISSION_RATIONALE_SHOWN, true)
    }
    ...
    protected open fun showPermissionDeniedDialog() {
        ...
        builder.setMessage(R.string.bouncer_camera_permission_denied_message)
            .setPositiveButton(R.string.bouncer_camera_permission_denied_ok) { _, _ ->
                storage.storeValue(com.gezebildiginkadar.camera.scan_ui.PERMISSION_RATIONALE_SHOWN, false)
                openAppSettings()
            }
