...
import com.gezebildiginkadar.camera.scan_ui.DebugOverlay
import com.gezebildiginkadar.camera.scan_ui.ScanActivity
...
//com.gezebildiginkadar.camera.ui.util.setDrawable(R.drawable.bouncer_flash_off_dark)
    ...
    protected open fun setupCardDetailsUi() {
     ...
     //       com.gezebildiginkadar.camera.ui.util.getFloatResource(R.dimen.bouncerPanStrokeSize), 0F, 0F,
      //      com.gezebildiginkadar.camera.ui.util.getColorByRes(R.color.bouncerCardPanOutlineColor)
       // )
       ...
       /* cardNameTextView.setTextColor(com.gezebildiginkadar.camera.ui.util.getColorByRes(R.color.bouncerCardNameColor))
        ...
        cardNameTextView.setShadowLayer(
            com.gezebildiginkadar.camera.ui.util.getFloatResource(R.dimen.bouncerNameStrokeSize), 0F, 0F,
            com.gezebildiginkadar.camera.ui.util.getColorByRes(R.color.bouncerCardNameOutlineColor)
        )*/
    }
